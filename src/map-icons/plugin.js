defineM("witsec-map-icons", function(g, mbrApp, tr) {
    mbrApp.registerPlugin("witsec-map-icons", {
        name: "map-icons",
        condition: !1,
        priority: 105,
        iconfont: {
